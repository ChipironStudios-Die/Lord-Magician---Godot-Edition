...
public static class GameData
{
	...
	public static readonly LevelDef[] Levels =
	{
		...
		new("Nivel 2 - El Bosque de Piedra", Decode(Map5), new Vector2(2.5f, 1.5f), new[]
		{
		...
		new("Nivel 3 - El Núcleo Arcano", Decode(Map6), new Vector2(1.5f, 1.5f), new[]
		{
		...
		new("Nivel 7 - El Puente", Decode(Map3), new Vector2(1.5f, 1.5f), new[]
		{
